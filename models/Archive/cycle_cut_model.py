...
class CycleCUTModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_A_GAN', 'D_A_real', 'D_A_fake', 'G_A', 'NCE_A', 'cycle_A', 
        'G_B_GAN', 'D_B_real', 'D_B_fake', 'G_B', 'NCE_B', 'cycle_B']
    ...
    def optimize_parameters(self):
        ...
        # self.loss_G_B = self.compute_G_B_loss()
    ...
    def compute_D_A_loss(self):
        ...
        # Real
        self.pred_B_real = self.netD_A(self.real_B)
    ...
    def compute_D_B_loss(self):
        ...
        # Real
        self.pred_A_real = self.netD_A(self.real_A)
    ...
    def compute_G_loss(self):
        ...
        self.loss_cycle_A = self.criterionCycle(self.rec_A, self.real_A) * 10 #lambda_A
        # Backward cycle loss || G_A(G_B(B)) - B||
        self.loss_cycle_B = self.criterionCycle(self.rec_B, self.real_B) * 10 #lambda_B
